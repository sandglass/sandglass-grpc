...
func (MergeOperation_Operation) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorSandglass, []int{25, 0}
}
...
type LastWALIndexRequest struct {
}

func (m *LastWALIndexRequest) Reset()                    { *m = LastWALIndexRequest{} }
func (*LastWALIndexRequest) ProtoMessage()               {}
func (*LastWALIndexRequest) Descriptor() ([]byte, []int) { return fileDescriptorSandglass, []int{20} }

type LastWALIndexReply struct {
	Index uint64 `protobuf:"varint,1,opt,name=index,proto3" json:"index,omitempty"`
}

func (m *LastWALIndexReply) Reset()                    { *m = LastWALIndexReply{} }
func (*LastWALIndexReply) ProtoMessage()               {}
func (*LastWALIndexReply) Descriptor() ([]byte, []int) { return fileDescriptorSandglass, []int{21} }

func (m *LastWALIndexReply) GetIndex() uint64 {
	if m != nil {
		return m.Index
	}
	return 0
...
func (*EndOfLogRequest) Descriptor() ([]byte, []int) { return fileDescriptorSandglass, []int{22} }
...
func (*EndOfLogReply) Descriptor() ([]byte, []int) { return fileDescriptorSandglass, []int{23} }
...
func (*MergeState) Descriptor() ([]byte, []int) { return fileDescriptorSandglass, []int{24} }
...
func (*MergeOperation) Descriptor() ([]byte, []int) { return fileDescriptorSandglass, []int{25} }
...
func init() {
	...
	proto.RegisterType((*LastWALIndexRequest)(nil), "sandglass.LastWALIndexRequest")
	proto.RegisterType((*LastWALIndexReply)(nil), "sandglass.LastWALIndexReply")
...
func (this *LastWALIndexRequest) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*LastWALIndexRequest)
	if !ok {
		that2, ok := that.(LastWALIndexRequest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *LastWALIndexReply) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*LastWALIndexReply)
	if !ok {
		that2, ok := that.(LastWALIndexReply)
		if ok {
			that1 = &that2
		} else {
			return false
...
type InternalServiceClient interface {
	...
	LastWALIndex(ctx context.Context, in *LastWALIndexRequest, opts ...grpc.CallOption) (*LastWALIndexReply, error)
...
func (c *internalServiceClient) LastWALIndex(ctx context.Context, in *LastWALIndexRequest, opts ...grpc.CallOption) (*LastWALIndexReply, error) {
	out := new(LastWALIndexReply)
	err := grpc.Invoke(ctx, "/sandglass.InternalService/LastWALIndex", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InternalServiceServer interface {
	...
	LastWALIndex(context.Context, *LastWALIndexRequest) (*LastWALIndexReply, error)
...
func _InternalService_LastWALIndex_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LastWALIndexRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InternalServiceServer).LastWALIndex(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sandglass.InternalService/LastWALIndex",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InternalServiceServer).LastWALIndex(ctx, req.(*LastWALIndexRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _InternalService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "LastWALIndex",
			Handler:    _InternalService_LastWALIndex_Handler,
		},
		{
			MethodName: "EndOfLog",
...
func (m *LastWALIndexRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *LastWALIndexRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *LastWALIndexReply) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *LastWALIndexReply) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *LastWALIndexRequest) Size() (n int) {
	var l int
	_ = l
	return n
}

func (m *LastWALIndexReply) Size() (n int) {
	var l int
	_ = l
	if m.Index != 0 {
		n += 1 + sovSandglass(uint64(m.Index))
...
func (this *LastWALIndexRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&LastWALIndexRequest{`,
		`}`,
	}, "")
	return s
}
func (this *LastWALIndexReply) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&LastWALIndexReply{`,
		`Index:` + fmt.Sprintf("%v", this.Index) + `,`,
		`}`,
	}, "")
	return s
...
func (m *LastWALIndexRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LastWALIndexRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LastWALIndexRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *LastWALIndexReply) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LastWALIndexReply: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LastWALIndexReply: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
var fileDescriptorSandglass = []byte{
	...
	,
}
